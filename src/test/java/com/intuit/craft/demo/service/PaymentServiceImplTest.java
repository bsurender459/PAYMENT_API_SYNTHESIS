...
public class PaymentServiceImplTest {
	...
	public void processPaymentNullObjectTest() throws Exception {
		Mockito.when(commonConfiguration.getPaymentApiUrl()).thenReturn("url");
		Mockito.when(commonConfiguration.getConnectionTimeOut()).thenReturn(6000);
		Mockito.when(commonConfiguration.getReadTimeOut()).thenReturn(6000);
		...
		logger.info("Received response from paypal payment service ",response);

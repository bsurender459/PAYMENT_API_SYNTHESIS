...
public class PaymentServiceImpl implements PaymentService {
	...
	public PaymentDTO processPayment(PaymentDTO paymentDTO) {
		logger.info("Received payment details from client ", paymentDTO.toString());
		...
		try {
			...
			logger.error("Error occured while processing paypal payment service", e.getMessage());
		}
	...
	private String getPaymentApiRequest(Payment payment) {
       logger.info("Sending payment to pay pal service ", payment.toString());
		String request = "{\n" + "  \"intent\": \"sale\",\n" + "  \"payer\": {\n"
